...
var zoomSteps = [
  ...
  { id: 2, border: 6e9 + 20e6/global.DistanceScale,           zoom_factor: 3 },          // from Jupiter to Pluto   / in km
  { id: 3, border: lyToKM(1.0) * global.starsDistanceScale,   zoom_factor: 15 },         // from Pluto to 1 ly   / in scaled km
  { id: 4, border: lyToKM(4.22) * global.starsDistanceScale,  zoom_factor: 60 },         // from 1 ly to first star (Proxima Centauri)  / in scaled km
