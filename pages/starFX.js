...
StarFX.prototype.init = function( pos,  size, color_shift ){
  ...
  this.starShader.uniforms['texture'].value = THREE.ImageUtils.loadTexture("textures/lensflare/star2.png");
  this.starShader.uniforms['texture_color'].value = THREE.ImageUtils.loadTexture("textures/lensflare/lensflare0.png");
  this.starShader.uniforms['color_shift'].value = color_shift;
  ...
  this.starShader.uniforms['noise_texture'].value = noise_tex;
  this.starShader.uniforms.resolution.value.x = window.innerWidth;
  this.starShader.uniforms.resolution.value.y = window.innerHeight;

  var material = new THREE.ShaderMaterial({

    uniforms: this.starShader.uniforms,
    vertexShader: this.starShader.vertexShader,
    fragmentShader: this.starShader.fragmentShader,
...
StarFX.prototype.update = function(){
  ...
  if ( this.isInView ){
    ...
    this.starShader.uniforms.time.value = clock.getElapsedTime();
